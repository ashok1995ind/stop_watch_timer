...
class StopWatchTimer {
  ...
  /// Get display Days .
  static String getDisplayDays(int days) {
    return getRawDays(days).floor().toString().padLeft(2, '0');
  }
  ...
  static int getRawDays(int value) => (value / (1000*60*60*24)).floor();

  /// Get Raw Hours.
  static int getRawHours(int value) => ((value / (1000 * 60 * 60)) % 24).floor();
